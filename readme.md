...
When working with larger sets, this can be resource intensive as results will be in the millions. The `CombineGenerator` func will allow you to create a pipeline and efficently iterate without eating much CPU or memory.
